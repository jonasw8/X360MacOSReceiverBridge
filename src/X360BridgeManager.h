...
@property(nonatomic) BOOL batteryKnown;
@property(nonatomic) BOOL batteryOnline;
@property(nonatomic) BOOL batteryCharging;
@property(nonatomic) uint8_t batteryLevel;
@property(nonatomic) uint8_t batteryPowerMode;
@property(nonatomic) uint8_t batteryRawFlags;
...
@property(nonatomic) NSInteger hidProfile; // 0 = Generic, 1 = Xbox 360, 2 = Xbox Series X
@property(nonatomic, readonly, copy) NSArray<NSString*>* virtualHIDDevices;
